        ...
        <TableBody>
          {Object.entries(artists).map(([key, artist]) => {
              return ( 
                ...
                <TableCell style={smoll} align="center"><AwesomeButton size='small' disabled={!artist.spotify} type='secondary' onPress={()=> window.open(artist.tiktok, 'tiktok')}>Spotify</AwesomeButton></TableCell>
                <TableCell style={smoll} align="center"><AwesomeButton size='small' disabled={!artist.yt} type='link' onPress={()=> window.open(artist.tiktok, 'tiktok')}>Youtube</AwesomeButton></TableCell>
              </TableRow> );
          })}
        </TableBody>
      </Table>
