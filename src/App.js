        ...
        <TableBody>
          {Object.entries(artists).map(([key, artist]) => {
              return ( 
                ...
                <TableCell style={smoll} align="center"><AwesomeButton size='small' disabled={!artist.spotify} type='secondary' onPress={()=> window.open(artist.spotify, 'tiktok')}>Spotify</AwesomeButton></TableCell>
